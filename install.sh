...
# Added jmwittl 20220128...
# Input argument input:
# if ("--skip-space-check"        ) skipSpaceCheck=true;;
# if ("--unattended"              ) runUnattended=true; unattendedConfig="${!j}";;
# if ("--reconfigure"             ) reconfigure=true;;
# if ("--show-unsupported-nics"   ) showUnsupportedNICs=true;;
# Added jmwittl 20220128...
